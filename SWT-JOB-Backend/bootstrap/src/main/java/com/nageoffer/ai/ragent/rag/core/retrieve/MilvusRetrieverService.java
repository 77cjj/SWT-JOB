...
public class MilvusRetrieverService implements RetrieverService {
    ...
    public List<RetrievedChunk> retrieveByVector(float[] vector, RetrieveRequest retrieveParam) {
        ...
        String logicalCollection = StrUtil.trim(retrieveParam.getCollectionName());
        SearchReq req = SearchReq.builder()
                .collectionName(
                        StrUtil.isBlank(logicalCollection) ? ragDefaultProperties.getCollectionName() : logicalCollection
                )
                .annsField("embedding")
                .data(vectors)
