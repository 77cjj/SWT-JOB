          ...
          <div className="flex gap-2">
            <div className="relative min-w-0 flex-1">
              ...
              <input
                ...
                placeholder="搜索对话..."
                className="h-10 w-full rounded-lg border border-[#E5E7EB] bg-[#F8FAFC] pl-9 pr-3 text-sm text-[#1F2937] placeholder:text-[#9CA3AF] focus:border-[#93C5FD] focus:outline-none transition-colors"
              />
            </div>
            <button
              type="button"
              className="inline-flex h-10 shrink-0 items-center justify-center gap-1.5 rounded-lg border border-[#E5E7EB] bg-white px-2.5 text-sm font-medium text-[#1F2937] transition-colors hover:bg-[#F8FAFC]"
              onClick={() => {
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <button
                              type="button"
                              className={cn(
                                "inline-flex size-7 shrink-0 items-center justify-center rounded-md border border-neutral-200/70 bg-white/90 text-[#666666] transition-opacity duration-150 hover:bg-[rgba(0,0,0,0.06)] dark:border-neutral-600 dark:bg-neutral-950/80",
                                currentSessionId === session.id
