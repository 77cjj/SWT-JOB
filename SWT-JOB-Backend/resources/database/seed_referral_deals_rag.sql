...
VALUES
  ...
  ('9100000000000000006', '换汇', '汇款 remittance 换汇软件', 1, 0),
  ('9100000000000000007', 'remitly', 'Remitly 汇款 refer', 1, 0),
  ('9100000000000000008', 'wise', 'Wise 换汇 refer', 1, 0),
  ('9100000000000000009', 'lemfi', 'LemFi 汇款', 1, 0)
