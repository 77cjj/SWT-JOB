-- 访客可浏览的示例对话（需先执行 upgrade_v1.4_to_v1.5.sql）

INSERT INTO t_sample_question (id, title, description, question, answer, sort_order, pinned, deleted)
VALUES
(
  '9100000000000000001',
  '岗位是夯还是拉？',
...
(
  ...
  '行前 4 周要做什么？',
  '签证·保险·行李',
  '离出发还有 4 周，SWT 行前最该先搞定哪 5 件事？请按优先级排序。',
...
(
  ...
  'SWT 回国怎么退税？',
  'W-2 与离境时间线',
  '项目结束了，我手里有 W-2，人还在美国，什么时候、怎么开始退税流程？',
...
(
  ...
  'Kalshi refer 怎么领？',
  '预测 + 加密成交量',
  'Kalshi 用邀请注册后，预测市场和加密市场分别要交易多少才能拿奖励？',
