...
export const referralPrograms: ReferralProgram[] = [
  ...
  },
  {
    ...
    siteRebateLabel: {
      zh: '平台奖励到账后本站返现一半（约 $5–75）',
      en: '50% site cashback after platform payout (~$5–75)',
    },
    ...
    editions: [
      {
        ...
        reward: {
          zh: '被邀请人可领 $25 Cash Reward；邀请人另有阶梯奖励 + 本站返现',
          en: 'Invitee $25 Cash Reward; referrer tier rewards + site cashback',
        },
        summary: {
          zh: '美区 Referral（2026/8/1–8/31）：经邀请链接开户 → 净入金 ≥$500 并维持日均资产 ≥$500 满 30 天。被邀请人可另领锁定 $25，需在领取后 14 天内入金 ≥$500 解锁。',
          en: 'US Referral (Aug 1–31, 2026): open via link → net deposit ≥$500 and keep avg assets ≥$500 for 30 days. Invitees may claim a locked $25, unlocked by depositing ≥$500 within 14 days.',
        },
        cardGuideBrief: {
          zh: '邀请链接开户 → 净入金≥$500 → 日均资产≥$500 维持 30 天（美区 / SSN）。',
          en: 'Open via link → net deposit ≥$500 → keep avg assets ≥$500 for 30 days (US / SSN).',
        },
        cardExtraBrief: {
          zh: '被邀请人可领 $25（14 天内入金≥$500 解锁）；本站平台奖到账后返一半。',
          en: 'Invitee: claim $25 (unlock with ≥$500 deposit in 14 days); site: 50% after platform payout.',
        },
        requirements: {
          zh: [
            '活动期：2026/8/1 00:00 – 8/31 23:59（美东时间）',
            '资格：美国居民、年满 18、持有效 SSN；须为从未在 Moomoo Financial Inc. 注册/开户的新用户',
            '邀请链接：https://j.moomoo.com/0ER7nH（或 Refer Code：M69D3EMM）',
            '邀请关系建立后 30 天内须完成入金，否则关系失效、双方无奖',
            '被邀请人核心门槛：净入金（入金−出金）≥ $500，并维持日均资产 ≥ $500 满 30 天',
            '被邀请人额外：$25 Cash Reward（邀请页手动领取，锁定态）→ 领取后 14 天内入金 ≥$500 解锁；每人限一份',
            '邀请人奖励：按官方「拼图」阶梯（每成功邀请 4 人拼完一关）发放 Cash / NVDA 股票券；第 13 人起每成功一人约 $100 NVDA（以 App 活动页为准）',
            '本站：官方平台奖励到账后返现一半（约 $5–75，浮动，以实际发放为准）',
          ],
          en: [
            'Period: Aug 1, 2026 00:00 – Aug 31, 2026 23:59 ET',
            'Eligibility: US residents, 18+, valid SSN; new users who never registered/opened at Moomoo Financial Inc.',
            'Referral: https://j.moomoo.com/0ER7nH (or code M69D3EMM)',
            'Referral link expires in 30 days if friend does not deposit',
            'Invitee core requirement: net deposit (deposits − withdrawals) ≥ $500 and maintain average assets ≥ $500 for 30 days',
            'Invitee bonus: locked $25 Cash Reward (manual claim on invite page) → deposit ≥ $500 within 14 days to unlock; one per invitee',
            'Referrer rewards: puzzle tiers (4 successful invites per puzzle) with Cash / NVDA stock coupons; from the 13th+ invite ≈ $100 NVDA each (see in-app T&Cs)',
            'Site: 50% cashback after official platform payout (~$5–75, varies)',
          ],
        },
        referralUrl: 'https://j.moomoo.com/0ER7nH',
        officialUrl: 'https://www.moomoo.com/us/support/topic4_448',
        tags: { zh: ['净入金≥$500', '维持30天', '8/31截止'], en: ['Net deposit ≥$500', '30-day hold', 'Until Aug 31'] },
      },
    ],
    howToClaim: {
      zh: [
        '点击本站邀请链接（或注册时填 Refer Code M69D3EMM）完成美区开户与 KYC。',
        '在邀请页手动领取锁定的 $25 Cash Reward（若活动页展示）。',
        '净入金 ≥ $500（入金减出金），并保持日均资产 ≥ $500 满 30 天；领取 $25 后须在 14 天内入金 ≥$500 才能解锁。',
        '邀请关系须在开户后 30 天内完成入金，否则失效。',
        '官方奖励到账后，按本站说明领取返现一半（约 $5–75）。条款以 Moomoo App / 帮助中心英文版为准。',
      ],
      en: [
        'Open a US Moomoo account via the referral link (or code M69D3EMM) and finish KYC.',
        'On the invite page, manually claim the locked $25 Cash Reward if shown.',
        'Make a net deposit ≥ $500 and keep average assets ≥ $500 for 30 days; unlock the $25 by depositing ≥ $500 within 14 days of claiming it.',
        'Deposit within 30 days of the referral relationship or it expires.',
        'After the official bonus posts, claim 50% site cashback (~$5–75). English T&Cs on Moomoo control.',
      ],
    },
    officialDetail: {
      zh: '官方条款摘要（来源：Moomoo US Help Center「Referral Promotion (2026/08/01-2026/08/31)」）：美区居民+SSN+18 岁；新用户经邀请链接开户；净入金≥$500 且日均资产≥$500 维持 30 天；邀请关系 30 天内未入金失效；被邀请人可领锁定 $25，领取后 14 天内入金≥$500 解锁。奖励形态多为 Cash Reward / 股票券，非直接可提现现金。本站返现为额外承诺。',
      en: 'Official summary (Moomoo US Referral Promotion 2026/08/01–2026/08/31): US + SSN + 18+; new account via referral; net deposit ≥$500 and avg assets ≥$500 for 30 days; 30-day referral expiry; invitee locked $25 unlocked by ≥$500 deposit within 14 days of claim. Rewards are often Cash Rewards / stock coupons, not free cash. Site rebate is separate.',
    },
  },
  {
    id: 'chime',
