    ...
    <div className="relative flex h-full min-h-0 w-full flex-1 flex-col items-center justify-start overflow-y-auto overflow-x-hidden overscroll-contain bg-white px-4 py-8 dark:bg-neutral-950 sm:px-6 sm:py-10">
      <div className="relative mx-auto w-full max-w-[860px] min-w-0">
        <div className="animate-fade-up text-center" style={{ animationFillMode: "both" }}>
          ...
          <h1 className="mt-4 font-display text-3xl leading-tight tracking-tight text-neutral-900 sm:text-5xl md:text-6xl dark:text-neutral-50">
        ...
        <div className="mt-8 animate-fade-up sm:mt-10" style={{ animationDelay: "80ms", animationFillMode: "both" }}>
          <div
            className={cn(
              "relative flex flex-col rounded-3xl border px-4 pt-4 pb-3 shadow-sm backdrop-blur-xl transition-all duration-200 sm:px-5",
            ...
            {promptPresets.map((preset) => {
              ...
              return (
                <button
                  ...
                  disabled={isStreaming}
                  className={cn(
                    "group min-w-0 w-full max-w-full rounded-2xl border p-4 text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md",
                ...
                >
                  <div className="flex min-w-0 items-start gap-3">
                    <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-indigo-50 text-indigo-600 dark:bg-indigo-950/80 dark:text-indigo-400">
                      <Icon className="h-4 w-4" />
                    </span>
                    <div className="min-w-0 flex-1">
                      <p className="truncate text-sm font-semibold text-neutral-900 dark:text-neutral-100">{preset.title}</p>
                      <p className="line-clamp-2 text-xs text-neutral-600 dark:text-neutral-400">{preset.description}</p>
                    </div>
                  </div>
                  <div className="mt-3 flex min-w-0 items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400">
