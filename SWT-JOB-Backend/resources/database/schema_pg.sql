...
CREATE TABLE t_deal_experience (
    id              VARCHAR(20)  NOT NULL PRIMARY KEY,
    user_id         VARCHAR(20)  NOT NULL,
...
CREATE INDEX idx_deal_exp_program ON t_deal_experience (program_id, edition_id);
CREATE INDEX idx_deal_exp_user ON t_deal_experience (user_id);
...
COMMENT ON COLUMN t_message.resources_json IS '资源引用JSON';
