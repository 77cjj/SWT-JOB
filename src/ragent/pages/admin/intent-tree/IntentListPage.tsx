...
const FILTER_SELECT_TRIGGER_CLASS =
  "h-10 text-sm border-[color:var(--admin-border)] bg-[color:var(--admin-surface)] text-[color:var(--admin-foreground)] focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 data-[state=open]:border-[color:var(--admin-border)] data-[state=open]:ring-0";
const FILTER_INPUT_CLASS =
  "h-10 border-[color:var(--admin-border)] bg-[color:var(--admin-surface)] pl-10 text-sm text-[color:var(--admin-foreground)] placeholder:text-[color:var(--admin-muted)] focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-[color:var(--admin-border)]";
  ...
  return (
    <div className="admin-page">
      ...
      <div className="space-y-3">
        <div className="rounded-xl border border-[color:var(--admin-border)] bg-[color:var(--admin-surface)] p-3">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button
                variant="outline"
                className="h-10 gap-1.5 border-[color:var(--admin-border)] bg-[color:var(--admin-surface)] px-3 text-sm text-[color:var(--admin-foreground)]"
              ...
              <Button
                variant="outline"
                className="h-10 gap-1.5 border-[color:var(--admin-border)] bg-[color:var(--admin-surface-2)] px-3 text-sm font-medium text-[color:var(--admin-muted)] hover:bg-[color:var(--admin-surface-2)] hover:text-[color:var(--admin-foreground)]"
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          onClick={() =>
                            navigate(
                              `/admin/intent-list/${row.id}/edit?from=${encodeURIComponent(router.asPath)}`
                            )
                          }
                        >
